      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {schemas.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center bg-surface border border-border rounded-2xl">
            ...
            <p className="text-text-subtle text-sm">{t("schemas.emptySchemas")}</p>
            <Link href="/schemas/new" className="text-primary-text hover:text-indigo-300 text-sm mt-2">
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center bg-surface border border-border rounded-2xl">
            ...
            <p className="text-text-muted text-sm font-medium">{t("schemas.noSearchResults")}</p>
              ...
              {paginatedSchemas.map((schema) => {
                ...
                return (
                  <Link
                    ...
                    className="bg-surface border border-border rounded-2xl p-5 hover:border-border-hover transition-colors flex flex-col gap-3 group"
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0">
                        <p className="text-sm font-semibold text-text-main group-hover:text-primary-text transition-colors truncate">
                          {schema.name}
                        </p>
                      ...
                      <div className="flex gap-1.5 shrink-0">
                        ...
                        {schema.storageLocation === "IPFS" && (
                          <span className="text-xs px-2 py-0.5 rounded-full font-medium bg-indigo-500/10 text-primary-text">
                            IPFS
                          </span>
                        )}
                      </div>
                    ...
                    {/* ID do Esquema */}
                    <div className="bg-surface-hover rounded-lg px-2.5 py-1.5 text-xs text-text-muted font-mono truncate">
                      <span className="text-text-subtle font-sans mr-1">{t("schemas.schemaId")}:</span>
                      {schema.id}
                    </div>

                    <div className="flex items-center justify-between text-xs text-text-subtle mt-auto pt-1">
