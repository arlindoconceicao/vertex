...
const sourceByPlatform = {
  linux: path.join(root, 'target', 'debug', 'libssi_pq_core.so'),
  darwin: path.join(root, 'target', 'debug', 'libssi_pq_core.dylib'),
  win32: path.join(root, 'target', 'debug', 'ssi_pq_core.dll')
};
